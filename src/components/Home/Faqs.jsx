const Faqs = () => {
  const Faqs = [
    {
      title: "What can I do with the chat feature in Aspire?",
      description: `Aspire offers both group chat and direct messaging capabilities.
    ...
    {
      title: `How does the task management feature in Aspire benefit my
              hackathon team?`,
      description: `Aspire's task management feature helps you stay organized by
    ...
    {
      title: `What is the advantage of using the canvas for real-time
              collaboration in Aspire?`,
      description: `The canvas feature in Aspire provides a virtual space where team
